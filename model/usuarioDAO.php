...
class UsuarioDAO{
    ...
    public function logarEmail($email, $senha){
        try{
            $sql = "SELECT u.id_usuario,u.nome_usu,u.email,u.senha,u.fk_id_perfil,p.nome_perfil FROM usuario u INNER JOIN perfil_usu p ON u.id_perfil = p.id_perfil WHERE email=? AND senha=?";
